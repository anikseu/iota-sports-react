    ...
    render() {
      ...
      return (
        ...
        <div className="container">
          ...
          <h2>Privacy Policy of <span class="website_url">cricintime.com</span></h2>

<p>At <span class="website_name">CricInTime</span>, we collect and manage user data according to the following Privacy Policy.</p>
...
<p>We only use your personal information to provide you the <span class="website_name">CricInTime</span> services or to communicate with you about the Website or the services. Our Privacy Policy was created with the help of the <a href="https://privacy-policy-template.com">Privacy Policy Template</a> and the <a href="https://termsfeed.com/privacy-policy/generator/">Privacy Policy Generator from TermsFeed</a> plus the <a href="https://termsandconditionstemplate.net">Terms and Conditions Template</a>.</p>
